...
Theta_Set <- list(list(Type=5, ThetaDF=tibble(Theta=0), Comps=c("CPI","CLWP","CLWPA"), corstr=NULL),
                  list(Type=5, ThetaDF=tibble(Theta=-0.02), Comps=c("CPI","CLWP","CLWPA"), corstr=NULL),
                  list(Type=5, ThetaDF=tibble(Theta=-0.04), Comps=c("CPI","CLWP","CLWPA"), corstr=NULL),
                  list(Type=4, ThetaDF=tibble(j=2:8, Theta=seq(from=-0.07,to=0.05,by=0.02)), Comps=c("CPI","CLWP","CLWPA"), corstr=NULL),
                  list(Type=4, ThetaDF=tibble(j=2:8, Theta=c(-0.07,-0.06,-0.04,0,0.03,0.02,0.01)), Comps=c("CPI","CLWP","CLWPA"), corstr=NULL),
                  list(Type=4, ThetaDF=tibble(j=2:8, Theta=c(rep(-0.03,4),rep(0,3))), Comps=c("CPI","CLWP","CLWPA"), corstr=NULL),
                  list(Type=3, ThetaDF=tibble(a=1:7, Theta=seq(from=-0.01,to=-0.04,by=-0.005)), Comps=c("CPI","CLWP","CLWPA"), corstr=NULL),
                  list(Type=3, ThetaDF=tibble(a=1:7, Theta=c(rep(0,2),rep(-0.03,5))), Comps=c("CPI","CLWP","CLWPA"), corstr=NULL),
                  list(Type=3, ThetaDF=tibble(a=1:7, Theta=seq(from=-0.07,to=0.05,by=0.02)), Comps=c("CPI","CLWP","CLWPA"), corstr=NULL))
