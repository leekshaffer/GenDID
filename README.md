...
N.B.: All workflows are designed to be run with the overarching folder
as the working directory, not the folder in which the script is found.
...
- *R*: Scripts for running the GenDID functions as well as the Xpert
  ...
  - *Xpert-analysis.R* conducts the full analysis using the synthetic
    Xpert data set in the *data* folder.
...
- *sim_R*: Scripts used for the creation, analysis, and compilation of
  ...
  functions from the *R* folder scripts to run properly.
